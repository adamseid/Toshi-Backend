...
import time
# from models import PersonalTopPerformanceGraph
...
def get_transactions(wallet_address, blockNumber):
    PersonalTopPerformanceGraph.objects.all().delete()
    ...
    for tx in data:
        ...
        # tpwp = PersonalTopPerformanceGraph(time=time, balance=current_balance)
        # tpwp.save()

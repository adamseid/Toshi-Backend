from .top_performers_table import Misc
import pandas as pd
from datetime import datetime
import time
from requests import get
from ..models import TopPerformanceGraph,AssetTable, DailyTopPerformers
from web3 import Web3
import requests
from Historic_Crypto import HistoricalData, Cryptocurrencies


FILE_NAME = 'TopPerformersTable'
DEBUG = True
...
# 0xa542f325990CEB47e2AE8BD9dccF8960b16eB7a9
...
def update():
    ...
    if not DailyTopPerformers.objects.filter(walletAddress=wallet_address).exists():
        ...
        dailyTopPerformers = DailyTopPerformers(
